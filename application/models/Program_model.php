...
class program_model extends CI_Model {
    ...
    public function create_item_detail_page($item, $form_div = true, $state = false) {
        ...
        $list.="<div class='panel panel-default' id='program_section' style='margin-bottom:0px;'>";
        $list.="<div class='panel-heading' style='text-align:left;'><h5 class='panel-title'>$item->fullname <input type='hidden' value='$item->keywords'></h5></div>";
        $list.="<div class='panel-body'>";
    ...
    public function get_item_detail_page($courseid, $keywords, $form_div = true, $state = false) {
        $query = "select id,fullname,summary,startdate,cost,discount_size "
    ...
    public function get_all_courses() {
        ...
        if ($num > 0) {
            ...
            foreach ($items as $item) {
                ...
                $list.="</div>";
                $list.="<div class='container-fluid' style='text-align:left;'>";
                $list.= "<span class='span6'><a href='https://" . $_SERVER['SERVER_NAME'] . "/programs/detailes/$item->id'>More</a></span>";
                $list.="</div>";
