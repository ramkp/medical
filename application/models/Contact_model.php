...
class Contact_model extends CI_Model {
    ...
    public function get_contact_form() {
        ...
        $list.="<span class='span9'>Please use e-mail as your first contact option,  allow up to 24 hours on weekdays and 48 hours on weekends.<br>
                Phone Hours: M-F 9am To 5pm (CST)</span>";
        $list.="</div>";
