...
<html  dir="ltr" lang="en" xml:lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/image.php/lambda/theme/1451892772/favicon" />
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="keywords" content="moodle, Medical2" />
        <link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/yui_combo.php?rollup/3.17.2/yui-moodlesimple-min.css" /><script id="firstthemesheet" type="text/css">/** Required in order to fix style inclusion problems in IE with YUI **/</script><link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/styles.php/lambda/1451892772/all" />
        <link href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/assets/css/full-slider.css" rel="stylesheet">
        <script type="text/javascript">
            //<![CDATA[
            var M = {};
            M.yui = {};
            M.pageloadstarttime = new Date();
            M.cfg = {"wwwroot": "http:\/\/<?php echo $_SERVER['SERVER_NAME']; ?>\/medical\/lms", "sesskey": "IwtRhLNoqd", "loadingicon": "http:\/\/<?php echo $_SERVER['SERVER_NAME']; ?>\/medical\/lms\/theme\/image.php\/lambda\/core\/1451892772\/i\/loading_small", "themerev": "1451892772", "slasharguments": 1, "theme": "lambda", "jsrev": "1451892663", "admin": "admin", "svgicons": true};
    ...
    <body  id="page-site-index" class="format-site course path-site safari dir-ltr lang-en yui-skin-sam yui3-skin-sam mycodebusters-com--medical-lms pagelayout-frontpage course-1 context-2 notloggedin two-column has-region-side-pre used-region-side-pre has-region-side-post used-region-side-post has-region-footer-left empty-region-footer-left has-region-footer-middle empty-region-footer-middle has-region-footer-right empty-region-footer-right has-region-hidden-dock empty-region-hidden-dock layout-option-nonavbar">
        ...
        <script type="text/javascript" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/yui_combo.php?rollup/3.17.2/yui-moodlesimple-min.js&amp;rollup/1451892663/mcore-min.js"></script><script type="text/javascript" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/jquery.php/core/jquery-1.11.3.min.js"></script>
        <script type="text/javascript" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/jquery.php/theme_lambda/jquery.easing.1.3.js"></script>
        <script type="text/javascript" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/jquery.php/theme_lambda/camera.min.1.11.js"></script>
        <script type="text/javascript" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/lms/theme/jquery.php/theme_lambda/jquery.bxslider.js"></script>
        <!--<script type='text/javascript' src='http://maps.googleapis.com/maps/api/js?key=AIzaSyA_7yjXzpz9sxQw6Ut0gFa8045N_I4QGXk'></script>-->        
        <script type="text/javascript" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/assets/js/custom.js"></script>        
        <script type="text/javascript" src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/assets/js/selectbox/jquery.selectBox.js"></script>        
        <script type="text/javascript">
            //<![CDATA[
                ...
                <nav class="navbar-inner">
                    <div class="container-fluid">
                        ...
                        <div class="nav-collapse collapse">
                            ...
                            <ul class="nav pull-right">                                
                                <li class="dropdown"><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/index.php/search"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/assets/logo/icon-search.png" style="cursor: pointer;" alt="search" id='search_item' /></a></li>
