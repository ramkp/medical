                        ...
                        <div class="row-fluid">
                            <?php if ($standardlayout) { ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php } ?>
                                    <?php
                                    $page = $ds->is_assignment_page();
                                    if ($page == 1) {
                                        $id = $ds->get_module_id();
                                        echo "<br><div style='text-align:center;'><button type='button' id='print_assignment' class='btn btn-primary' data-moduleid=$id>Print</button></div><br>";
                                    }
