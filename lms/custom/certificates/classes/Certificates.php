    ...
    function get_certificate_template($courseid, $userid, $date = 0, $code = '', $renew = false) {
        ...
        switch ($courseid) {
            ...
            case 41:
                ...
                // President signature
                $list.="<br><br><p align='center'><table border='0' width='675px;'><tr><td align='right' style='font-family:king;text-decoration:underline;border-bottom:thick;font-size:10pt;'> Mrs. Donna Steele<br/><span style='float:left;font-size:12pt;font-family: Geneva, Arial, Helvetica, sans-serif;text-decoration:none; '>Director</span></td><td align='right' style='font-family:king;text-decoration:underline;border-bottom:thick;font-size:10pt;'>Mrs. P. Nicole Morrison<br/><span style='float:left;font-size:12pt;font-family: Geneva, Arial, Helvetica, sans-serif;text-decoration:none; '>Director of Programs</span></td></tr></table></p";
                $list.="</div>";
    ...
    function create_new_certificate($cert, $issue, $expire) {
        ...
        switch ($cert->courseid) {
            ...
            case 45:
                ...
                $list.="<span style='align:center;font-weight:bold;font-size:15pt;'>Presents this Phlebotomy with EKG certification the $day of $month $year To:</span>";
                $list.="<br><br><span style='align:center;font-size:20pt;'>$firstname $lastname</span><br>";
                $list.="<br><span style='width:675px;align:center;padding-left:35px;padding-right:35px;font-size:15pt;'>For the successful completion of hands-on workshop & exam.
                Medical2 Certification Agency's workshop covered topics: basic anatomy of the arm, 
                needle/syringe, lancet, winged infusion (butterfly), routine venipuncture, evacuated tube
                system, order of the draw, safety and corrective techniques.<br><br>"
                        . "The workshop also discusses procedures to perform an Electrocardiogram.</span>";
